...
public class Database {
    ...
    protected static boolean saveProfile(String uid, String firstName, String lastName, int age, ImageView imageView) {
        Profile profile = new Profile(uid, firstName, lastName, age);
        mDatabase.child("profiles").child(uid).setValue(profile);

        uploadImgFromView(imageView, uid);

        return true;
    }

    private static void uploadImgFromView(ImageView imageView, String uid) {
